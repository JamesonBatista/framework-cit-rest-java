...
import static util.Exclud.FilesSystem;
...
public class CITRestAssured extends  validationResponse{
    ...
    static void ValidationResponse() throws Exception {
        Response res = result.extract().response();
        if (res.asString().isEmpty() || res.asString().contains("{}")) {
            System.err.println("Seu retorno do método  está vazio.  \n" +
    ...
    public ValidatableResponse Get() throws Exception {
        try {
            result = Given()
                    .when()
                    .get()
    ...
    public ValidatableResponse GetEndpoint(String Endpoint) throws Exception {
        try {
            result = Given()
                    .when()
                    .get(Endpoint)
    ...
    public ValidatableResponse GetParamHeaderEndpoint(String Endpoint) throws Exception {
        try {
            result = Given()
    ...
    public ValidatableResponse GetParam() throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .when()
    ...
    public ValidatableResponse GetParamEndpoint(String Endpoint) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .when()
    ...
    public ValidatableResponse GetParamHeader() throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .headers(headers.toString() == "{}" ? null : headers)
    ...
    public ValidatableResponse GetHeader() throws Exception {
        try {
            result = Given()
                    .headers(headers.toString() == "{}" ? null : headers)
                    .when()
    ...
    public ValidatableResponse GetHeaderEndpoint(String Endpoint) throws Exception {
        try {
            result = Given()
                    .headers(headers.toString() == "{}" ? null : headers)
                    .when()
    ...
    public ValidatableResponse Post() throws Exception {
        try {
            result = Given()
                    .when()
                    .post()
    ...
    public ValidatableResponse PostBody(String body) throws Exception {
        try {
            result = Given()
                    .body(body)
                    .when()
    ...
    public ValidatableResponse PostBodyEndpoint(String body, String Endpoint) throws Exception {
        try {
            result = Given()
                    .body(body)
                    .when()
    ...
    public ValidatableResponse PostParamHeaderBodyEndpoint(String body, String Endpoint) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .headers(headers.toString() == "{}" ? null : headers)
    ...
    public ValidatableResponse PostParamHeaderBody(String body) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .headers(headers.toString() == "{}" ? null : headers)
    ...
    public ValidatableResponse PostParamBodyEndpoint(String body, String Endpoint) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .body(body)
    ...
    public ValidatableResponse PostParamBody(String body) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .body(body)
    ...
    public ValidatableResponse PostHeaderBody(String body) throws Exception {
        try {
            result = Given()
                    .headers(headers.toString() == "{}" ? null : headers)
                    .body(body)
    ...
    public ValidatableResponse PostHeaderBodyEndpoint(String body, String Endpoint) throws Exception {
        try {
            result = Given()
                    .headers(headers.toString() == "{}" ? null : headers)
                    .body(body)
    ...
    public ValidatableResponse PutBody(String body) throws Exception {
        try {
            result = Given()
                    .body(body)
                    .when()
    ...
    public ValidatableResponse PutBodyEndpoint(String body, String Endpoint) throws Exception {
        try {
            result = Given()
                    .body(body)
                    .when()
    ...
    public ValidatableResponse PutParamHeaderBodyEndpoint(String body, String Endpoint) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .headers(headers.toString() == "{}" ? null : headers)
    ...
    public ValidatableResponse PutParamHeaderBody(String body) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .headers(headers.toString() == "{}" ? null : headers)
    ...
    public ValidatableResponse PutParamBodyEndpoint(String body, String Endpoint) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .body(body)
    ...
    public ValidatableResponse PutParamBody(String body) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .body(body)
    ...
    public ValidatableResponse PutHeaderBody(String body) throws Exception {
        try {
            result = Given()
                    .headers(headers.toString() == "{}" ? null : headers)
                    .body(body)
    ...
    public ValidatableResponse PutHeaderBodyEndpoint(String body, String Endpoint) throws Exception {
        try {
            result = Given()
                    .headers(headers.toString() == "{}" ? null : headers)
                    .body(body)
    ...
    public ValidatableResponse Delete() throws Exception {
        try {
            result = Given()
                    .when().delete()
                    .then();
    ...
    public ValidatableResponse DeleteEndpoint(String Endpoint) throws Exception {
        try {
            result = Given()
    ...
    public ValidatableResponse DeleteParam() throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .when().delete()
    ...
    public ValidatableResponse DeleteParamEndpoint(String Endpoint) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .when().delete(Endpoint)
    ...
    public ValidatableResponse DeleteParamHeader() throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .headers(headers.toString() == "{}" ? null : headers)
    ...
    public ValidatableResponse DeleteHeader() throws Exception {
        try {
            result = Given()
                    .headers(headers.toString() == "{}" ? null : headers)
                    .contentType(ContentType.JSON)
    ...
    public ValidatableResponse DeleteHeaderEndpoint(String Endpoint) throws Exception {
        try {
            result = Given()
                    .headers(headers.toString() == "{}" ? null : headers)
                    .contentType(ContentType.JSON)
    ...
    public ValidatableResponse DeleteParamHeaderEndpoint(String Endpoint) throws Exception {
        try {
            result = Given()
                    .queryParams(params.toString() == "{}" ? null : params)
                    .headers(headers.toString() == "{}" ? null : headers)
